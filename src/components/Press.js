                    ...
                    <Card maxW='lg'>
                        <CardBody>
                            <Stack mt='6' spacing='3'>
                                ...
                                <Heading>Fecking Bahamas Feature</Heading>
                                <Image src={bahamas}></Image>
                                </a>
                                <Text>Seattle is a place that hardly needs an introduction when it comes to fostering great music, and we’re not just talking about the whole grunge revolution thing. It’s just one of those places that has all the necessary ingredients for a lot of creative people, even if it’s in a begrudging way.</Text>
                            </Stack>
                        </CardBody>
                    </Card>
                    <Card maxW='lg'>
                        <CardBody>
                            <Stack mt='6' spacing='3'>
                                ...
                                <Heading>Ghettoblaster Premiere</Heading>
                                <Image src={gb}></Image>
                                </a>
                                <Text>Seattle three-piece No Edits share a single from their forthcoming full-length, We All End Up The Same (Better Days Will Haunt You). Listen to “Time You Kill.”</Text>
                            </Stack>
                        </CardBody>
                    </Card>
                    <Card maxW='lg'>
